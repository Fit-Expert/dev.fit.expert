...
<link rel="stylesheet" href="{{ asset('public/admin_assets/plugins/daterangepicker/daterangepicker.css')}}">
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020-2021 <a href="Javasript:void(0);">Admin</a>.</strong>
    All rights reserved.
  </footer>
...
<?php
if(Request::path()!="admin/calendar"){
?>
<!-- jQuery -->
...
<script src="{{ asset('public/admin_assets/plugins/chart.js/Chart.min.js')}}"></script>
...
<script src="{{ asset('public/admin_assets/plugins/jqvmap/maps/jquery.vmap.usa.js')}}"></script>

<script src="{{ asset('public/admin_assets/plugins/jquery-knob/jquery.knob.min.js')}}"></script>

<script src="{{ asset('public/admin_assets/plugins/moment/moment.min.js')}}"></script>
<script src="{{ asset('public/admin_assets/plugins/daterangepicker/daterangepicker.js')}}"></script>
...
$.ajaxSetup({
    ...
    eventDrop: function (event, data) {
      ...
      var nextdayObj = new Date(startObj);
      nextdayObj.setDate(startObj.getDate()+1);
      var convertEndDate=nextdayObj.toLocaleDateString();

      var strtDateArr = start.split(" ");
      var startTime=strtDateArr[1];

      var endDateArr = convertEndDate.split("/");
      var end=endDateArr[2]+'-'+endDateArr[1]+'-'+endDateArr[0]+' '+startTime;
